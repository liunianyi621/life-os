...
function createRuntime(initialState = oldState()) {
  ...
  ["js/storage.js", "js/tasks.js", "js/habits.js", "js/economy.js", "js/settlement.js", "js/stats-data.js", "js/stats.js"].forEach(file => {
...
test("过去金币金额只迁移一次，未来配置保持原值", () => {
  ...
  assert.equal(value(context, "typeof NO_BAD_HABIT_BONUS"), "undefined");
